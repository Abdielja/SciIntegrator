...
public abstract class Transaction implements ITransaction, Serializable
{
  ...
  /**
   * @param strAsynchronous the strAsynchronous to set
   */
  ...
  public boolean isAsynchronous()
  {
    ...
    if (asynchronous.contentEquals("true"))
    {
      return true;
    }
    else
  ...
  */
  ...
  /**
   * @param trxError the trxError to set
   */
  ...
  public void validate() throws SciiException
  {
    ...
    {
      throw new SciiException("Transaction Date Error '" + this.getcreationDate() + "' - Creation date must be greater than or equal to user's last balance date");
    }
